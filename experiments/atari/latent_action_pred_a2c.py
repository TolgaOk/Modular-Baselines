...
from modular_baselines.contrib.model_based.latent_a2c import LatentActionPredA2C
from modular_baselines.contrib.model_based.vae import LatentActionPredictionVae
...
class LatentActionPredPolicy(Policy):
    def _init_networks(self):
        self.vae = LatentActionPredictionVae(
...
def run(args):
    ...
    # Policy
    policy = LatentActionPredPolicy(vecenv.observation_space,
                                    vecenv.action_space,
    ...
    collector = OnPolicyCollector(env=vecenv,
                                  ...
                                  device=args.device)
    # Model
    model = LatentActionPredA2C(policy=policy,
