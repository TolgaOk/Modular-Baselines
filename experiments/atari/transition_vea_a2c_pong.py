...
from modular_baselines.contrib.model_based.latent_a2c import TransitionModelA2C
from modular_baselines.contrib.model_based.vae import TransitionVae
...
def run(args):
    ...
    # Policy
    policy = TransitionPolicy(vecenv.observation_space,
                              vecenv.action_space,
    ...
    collector = OnPolicyCollector(env=vecenv,
                                  ...
                                  device=args.device)
    # Model
    model = TransitionModelA2C(policy=policy,
